...
# for i in range(1, 5):
# 	for j in range(1, 5):
# 		pygame.draw.rect(screen,GREEN,(i*100, j*100, 95, 95))
...
# print(birOutputstate)
# print(sifirOutputstate)
...
# circ[0].draw(output='mpl', filename='circ0.png')
# circ.draw()
...
# while(True):
# 	bastir()
# 	print("Hamle sirasi: " + str(hamleKimde));
# 	if(gecerliHamleVarMi() == True):
# 		print("OYUN BITTI")
# 		break
# 	if(True):
# 		bilgisayarHamleYap()
# 	else:
# 		print("Hamlenizi yaziniz: ", end = '')
# 		move = input()
# 		move = move.replace(" ", "")
# 		i = int(move[0])
# 		j = int(move[1])
# 		hamle(i, j, hamleKimde, move[2])
